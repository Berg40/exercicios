...
function mostrarExercicio(grupo) {
    ...
    if (exercicios[grupo]) {
        exercicios[grupo].forEach(src => {
            ...
            legenda.style.wordBreak = "break-word";  // Quebra de linha se necessário
            legenda.style.whiteSpace = "normal";  // Permite quebra de linha
            legenda.style.maxWidth = "130px";  // Limita a largura da legenda
            legenda.style.marginLeft = "auto"; // Centraliza horizontalmente
            legenda.style.marginRight = "auto"; // Centraliza horizontalmente
